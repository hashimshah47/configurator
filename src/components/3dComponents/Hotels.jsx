...
// },[meshes.length])
  ...
  return (
    <>
        {currentInstrument=='hotel' && currentInstrumentSelected && positionArr.map((val, index) => {
            return (
              <mesh
          ...
          {instrumentsList.filter(mesh => mesh.shape === 'hotel').map((mesh, index) =>{ return (
            <mesh key={index} >
              <HotelModel positions={mesh.position}/>
            </mesh>
          )})}
    </>
  )
